...
public class Content_Adhamya extends AppCompatActivity {
    private DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Club_Content/Adhamya");
    TextView card1_content,card2_content,card3_content;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_content__adhamya);
        //toolbar
