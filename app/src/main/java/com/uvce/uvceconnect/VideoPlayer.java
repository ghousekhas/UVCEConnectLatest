...
public class VideoPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentView = findViewById(R.id.exoplayer);

        PlayerView videoplayer=findViewById(R.id.exoplayer);
        ...
        MediaSource mediaSource=new ExtractorMediaSource(Uri.parse("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/VolkswagenGTIReview.mp4"),
                new DefaultDataSourceFactory(this, Util.getUserAgent(this, "mediaPlayerSample"),new DefaultBandwidthMeter()), new DefaultExtractorsFactory(), null, null);
