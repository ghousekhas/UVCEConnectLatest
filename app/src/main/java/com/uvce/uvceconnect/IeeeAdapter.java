...
public class IeeeAdapter extends RecyclerView.Adapter<IeeeAdapter.MyViewHolder>{
    List<String> clubs;
    Activity activity;
    Context context;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.ieeecard,parent,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View v){
            super(v);
            imageView=v.findViewById(R.id.ieeecardimageview);
            space=v.findViewById(R.id.ieeespace);
        }
    }
}
